<template>
  <div class="lend_plan_list_content">
    <div class="content">
      <mt-loadmore class="loadmorestwo"  ref="loadmore" :maxDistance="90">
        <!--<div class="tab">-->
          <!--<div class="today"><span class="active">今日</span></div>-->
          <!--<div class="month" @click="changeRouterMonth"><span>本月</span></div>-->
        <!--</div>-->
  ...
  export default {
    ...
    methods: {
          ...
          if(res.data.code == 200){
              ...
              if (item.id == 412)
            {
              ...
              for (var i = 0; i < this.dataItem.length; i++) {
                this.score += this.dataItem[i].value *1
              }
            }
            })
      ...
      changeRouterMonth(){//本月
        this.$router.push('/lendPlanList/month?currentType='+this.$route.query.currentType);
      }
    },
    updated(){
