<template>
  <div class="main_wrap">
    <header-nav :activeId='1' :type="1" :fixedHead="true"></header-nav>
    <mt-loadmore  class="loadmorestwo"   :top-method="loadTop"  @top-status-change="handleTopChange" ref="loadmore" :maxDistance="90">
      ...
      <div v-if="!isNoData">
        <look-lend-money :tagsType="true"  :currentLendData="currentLendData" :reshtime="reshtime" :todayCha="todayCha"></look-lend-money>
      ...
      battleList(type) {
        ...
        this.$ajax({
          ...
          data: JSON.stringify({
            ...
            // subjectId: '404',
            subjectId: this.timeBattleHomeNavs[1].id,
            masterNo: '04'
          })
        })
