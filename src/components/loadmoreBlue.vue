<template>
  <mt-loadmore ref="loadmore" class="loadmorestwo" :top-method="loadTop" @top-status-change="handleTopChange" @bottom-status-change="handleBottomChange" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded||isNoData||!needBottom" :maxDistance="90">
    <slot>
