<template>
  <div class="page">
    ...
    <mt-loadmore class="loadmores fixed-container" :class="{'iphonex-tab-container':isIphoneX,'iphonex-loadmores':isIphoneX}" :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" @top-status-change="handleTopChange" @bottom-status-change="handleBottomChange" :maxDistance="90">
      ...
      this.$ajax({
        ...
        .then(
          res => {
            ...
            this.changeTopStatus('succeeded')
            if (res.data.code == 200) {
