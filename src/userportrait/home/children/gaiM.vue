<template>
  <div class="gaim_wrap">
    <mt-loadmore v-show="!isNoData" class='loadmorestwo'  :top-method="loadTop"  @top-status-change="handleTopChange" ref="loadmore" :maxDistance="90">
